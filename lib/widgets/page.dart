...
import 'package:aria/widgets/deferred_widget.dart';
...
abstract class ScrollablePage extends Page {
  ...
  Widget buildHeader(BuildContext context, WidgetRef ref) => const SizedBox.shrink();

  Widget buildBottomBar(BuildContext context, WidgetRef ref) => const SizedBox.shrink();
...
class DeferredPage extends Page {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return DeferredWidget(libraryLoader, () => createPage().build(context, ref));
  }
}
